...
class PgVectorStoreTests(unittest.TestCase):
    ...
    @patch("app.vectorstore.pgvector_store.psycopg2.connect")
    ...
    @patch("app.vectorstore.pgvector_store.psycopg2.connect", side_effect=Exception("Database refused connection"))
