...
class TestFastAPIEndpoints(unittest.TestCase):
    ...
    def test_document_upload_and_rag_chat_endpoint(self):
        ...
        with patch("backend.rag.service.RAGService.ingest", return_value={"chunks_indexed": 3, "vectors_stored": 3}):
            response = self.client.post(
        ...
        with patch("backend.rag.service.RAGService.ask", return_value={
